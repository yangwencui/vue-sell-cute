    ...
    <div class="overview">
      ...
      <div class="bulletin">
        ...
        <ul v-if="seller.supports" class="supports">
          <li class="support-item border-bottom-1px" v-for="(item,index) in seller.supports" :key="item.id">
...
<script>
  ...
  import { saveToLocal, loadFromLocal } from '../../comment/js/storage'

  export default {
    name: 'seller',
    components: { SupportIcon, Split, Star },
    props: {
      data: {
        type: Object,
        default () {
